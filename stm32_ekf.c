 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Dec 25 09:49:21 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                stm32_ekf
...
#define INPUT_0_DIMS_ND                {7,1}
#define INPUT_0_NUM_ELEMS              7
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u of S-Function stm32_ekf");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y of S-Function stm32_ekf");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  stm32_ekf_Outputs_wrapper(u, y, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  real32_T *y = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *xD = ssGetDiscStates(S);
  stm32_ekf_Update_wrapper(u, y, xD);
}
