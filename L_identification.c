 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Dec 25 09:49:29 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                L_identification
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u of S-Function L_identification");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y of S-Function L_identification");
      return;
    }
...
static void mdlStart(SimStruct *S)
{
  ...
  L_identification_Start_wrapper(xD);
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  L_identification_Outputs_wrapper(u, y, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  real32_T *y = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *xD = ssGetDiscStates(S);
  L_identification_Update_wrapper(u, y, xD);
}
